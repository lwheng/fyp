...
For a more conclusive evaluation, I continue evaluating {\it GvS} by training on the unskewed data set, and then testing on the rest of the entire data set.
%
