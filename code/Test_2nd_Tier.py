...
if __name__ == "__main__":
  ...
  # Write out X
  pickle.dump(X_train, open(os.path.join(path_pickles, 'X_2nd_Tier_Best.pickle'),'wb'))
  ## Write out y
  pickle.dump(y_train, open(os.path.join(path_pickles, 'y_2nd_Tier_Best.pickle'),'wb'))
